...
const FOOD_DATA = {
    "🍕 Пицца": [
        ...
        { id: "p16", name: "С лососем и рукколой", price: 719, desc: "Лосось, сливочный сыр, свежая руккола" }
    ],
    "🍔 Бургеры": [
        { id: "b1", name: "Тройной чизбургер", price: 249, desc: "3 котлеты, 3 сыра, фирменный соус" },
        { id: "b2", name: "Биг Спешиал", price: 460, desc: "Огромная говяжья котлета, овощи" },
        { id: "b5", name: "Биг Хит", price: 303, desc: "Легендарный соус, две котлеты" },
        { id: "b8", name: "Гранд", price: 327, desc: "Классика вкуса, сочная говядина" },
        { id: "b14", name: "Цезарь ролл", price: 230, desc: "Курица в пшеничной лепешке" }
    ],
    "🥤 Напитки": [
        { id: "d1", name: "Кола", price: 111, desc: "Классический освежающий напиток" },
        { id: "d3", name: "Капучино", price: 159, desc: "Ароматный кофе с густой пенкой" },
        { id: "d6", name: "Сок", price: 128, desc: "Натуральный апельсиновый сок" },
        { id: "d14", name: "Латте", price: 119, desc: "Нежный кофейный напиток" },
        { id: "d20", name: "Вода", price: 111, desc: "Чистая артезианская вода" }
    ]
};
