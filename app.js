...
const FOOD_DATA = {
    ...
    "🍔 Бургеры": [
        ...
        { id: "b5", name: "Двойной Биг Хит", price: 303, desc: "Легендарный соус, две котлеты" },
    ...
    "🥤 Напитки": [
        ...
        { id: "d3", name: "Капучино Печенье-Орех", price: 159, desc: "330 мл сладкого кофе" },
        { id: "d6", name: "Апельсиновый сок", price: 128, desc: "Натуральный сок 0.5 л" },
        { id: "d14", name: "Латте", price: 119, desc: "Нежная молочная пенка" },
        { id: "d20", name: "Вода негаз.", price: 111, desc: "Артезианская вода 0.5 л" }
    ]
};
